...
var cornerPositionsBluebird = []Position{
...
var cornerPositionsVivace = []Position{
	{ // Schwanenwik bridge, actually the last, just here to offer historical data
		Boat:        "Vivace",
		Latitude:    53.565728,
		Longitude:   10.015460,
		MeasureTime: time.Date(2023, time.December, 31, 23, 59, 54, 0, time.UTC),
	...
	{ // Bottomleft corner
		...
		Latitude:    53.558629,
		Longitude:   9.996797,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 6, 0, time.UTC),
	},
	{ // Alsterufer
		Boat:        "Vivace",
		Latitude:    53.565851,
		Longitude:   10.002505,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 12, 0, time.UTC),
	},
	{ // Alsterpark
		Boat:        "Vivace",
		Latitude:    53.573737,
		Longitude:   10.003055,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 18, 0, time.UTC),
	},
	{ // North East
		Boat:        "Vivace",
		Latitude:    53.576946,
	...
	{ // middle of Langer Zug entry
		...
		Latitude:    53.576092,
		Longitude:   10.005250,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 34, 0, time.UTC),
	},
	{ // pier north
		Boat:        "Vivace",
		Latitude:    53.577342,
		Longitude:   10.009071,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 38, 0, time.UTC),
	},
	{ // pier south
		Boat:        "Vivace",
		Latitude:    53.576996,
		Longitude:   10.009439,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 40, 0, time.UTC),
	},
	{ // middle of Langer Zug entry
		Boat:        "Vivace",
		Latitude:    53.576092,
		Longitude:   10.005250,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 44, 0, time.UTC),
	},
	{ // Hansa Steg
		Boat:        "Vivace",
		Latitude:    53.568951,
		Longitude:   10.009498,
		MeasureTime: time.Date(2024, time.January, 1, 0, 0, 50, 0, time.UTC),
	},
	{ // Schwanenwik bridge, actually the last, just here to offer historical data
		Boat:        "Vivace",
		Latitude:    53.565728,
